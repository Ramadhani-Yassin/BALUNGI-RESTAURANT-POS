        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Card and Mobile Payment</h3>
                </div>
                <div class="card-body">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($check_payment_result) {
                            ...
                            if ($row['card_id'] !== null) {
                                ...
                                echo '<div class="d-flex flex-column align-items-center mt-3">';
                                echo '<a href="posTable.php" class="btn btn-dark mb-2">Back to Tables</a>';
